...
def update_slide(requests, slide, date_text, body_text, slide_num):
    ...
    # remove existing images on duplicated slides to leave clean placeholders for manual insertion
    for image in images:
        requests.append({'deleteObject': {'objectId': image['objectId']}})
